  ...
  render() {
    ...
    return (
      <>
        ...
        <h1>Mensagem motivacional</h1>
        <br></br>
        <h2 data-testid="feedback-total-question">Você acertou { assertions } { questao }!</h2>
        <h2 data-testid="feedback-total-score">Um total de { score } pontos.</h2>
      </>
    );
  }
}
